    ...
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <div className="mt-6">
          <Link
            to="/"
            className="inline-flex items-center justify-center rounded-md bg-primary px-4 py-2 text-sm font-medium text-primary-foreground hover:bg-primary-dark transition-colors"
          >
            Go home
          </Link>
        </div>
  ...
  head: () => ({
    meta: [
      ...
      { title: "JanSeva Protocol — Justice for everyone. Owned by no one." },
      {
        name: "description",
        content:
          "A capture-resistant, AI-powered civic platform. Anonymous submissions, transparent audit log, and decentralized stewardship.",
      },
